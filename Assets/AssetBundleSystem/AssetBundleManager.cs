...
public class AssetBundleManager : MonoBehaviour
{
    ...
    public static readonly int Version = 01010040;
    ...
    public static string serverURL = "http://127.0.0.1:8090";
       ...
       // string progressTxt = "";
        ...
        for (int i = 0; i < count;)
        {
            ...
            yield return StartCoroutine(DownLoadAssetBundle(bundleName, (percent) =>
            {
                ...
                double temp = Math.Round(( size * currentProgress+currentSize) / (1024 * 1024), 1);
